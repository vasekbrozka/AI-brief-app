...
| 9 | Na počítači byl brief pořád jen dlouhý seznam karet vedle sebe ve sloupcích — stejný model čtení jako na telefonu, včetně přepínače Dnes / Top shots. | Na šířce se vedle novinek vejde i to, jak čtení jde, a celý týden; přepínat mezi dneškem a týdnem je tam zbytečné a prázdné pásy po stranách nic nenesou. | Tři sloupce. Uprostřed novinky pod sebou jako na telefonu, obsah roluje. Vlevo stojí sloupec s postupem dne nahoře (čárkovaný pruh), sérií čtení uprostřed (den po dni na výšku) a hodnocením dole. Vpravo Top shots a tipy, které rolují uvnitř sloupce, a dole zafixované Poslat dnešní shot. Oba krajní sloupce drží jednu obrazovku a nehýbou se. Od 1400 px; pod tím dva sloupce, na telefonu seznam s přepínačem. |
