...
| 9 | Na počítači byl brief pořád jen dlouhý seznam karet vedle sebe ve sloupcích — stejný model čtení jako na telefonu. | Na šířce 1100 px a víc se celá novinka vejde na obrazovku bez rolování; sloupce nutily číst očima nahoru a dolů a nikde nebylo vidět, kde v dnešku jsem. | Čtečka po novinkách: otevřená novinka je naše běžná karta přes celý sloupec (max. 860 px, ať se řádek dá přečíst), pod ní tlačítko „Přečteno, další“, dole pruh se zbytkem dne a vpravo tipy, série a hodnocení. Postup dne je v horní liště. Mění se jen rozložení, komponenty zůstaly. Telefon zůstal u seznamu. |
