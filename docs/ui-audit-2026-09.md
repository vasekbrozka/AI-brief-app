...
| 9 | Na počítači byl brief pořád jen dlouhý seznam karet vedle sebe ve sloupcích — stejný model čtení jako na telefonu. | Na šířce 1100 px a víc se celá novinka vejde na obrazovku bez rolování; sloupce nutily číst očima nahoru a dolů a nikde nebylo vidět, kde v dnešku jsem. | Čtečka po novinkách: otevřená novinka zabírá stránku (číslo v rohu je zároveň přepínač Vypito), pod ní lišta akcí s tlačítkem „Přečteno, další“, dole pruh se zbytkem dne a vpravo série, tipy a hodnocení. Postup dne je v horní liště. Telefon zůstal u seznamu. |
