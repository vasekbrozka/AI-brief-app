...
| 9 | Na počítači byl brief pořád jen dlouhý seznam karet vedle sebe ve sloupcích — stejný model čtení jako na telefonu, včetně přepínače Dnes / Top shots. | Na šířce se vedle novinek vejde i celý týden a jak čtení jde; přepínat mezi dneškem a týdnem je tam zbytečné a prázdné pásy po stranách nic nenesou. | Od 1400 px je Brief aplikační rám na jednu obrazovku: stránka se neroluje, roluje jen sloupec s novinkami (stejné karty jako na telefonu, do 1100 px šířky). Vpravo jemně podbarvená sekce, která roluje uvnitř sebe: Top shots (čtyři dny, ať se vejdou), tipy a série čtení v podobě z telefonu; dole v ní zafixovaný řádek Sdílet + palce. Sekce začíná nahoře u data, hlavička zůstává nad novinkami a postup dne je čárkovaný pruh na jejím metařádku. Plovoucí lišta je v tomhle rámu vypnutá. Pod 1400 px dva sloupce, na telefonu seznam s přepínačem. |
