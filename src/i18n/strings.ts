...
export const STRINGS: Record<Lang, UIStrings> = {
  cs: {
    ...
    releaseAdded: [
      ...
      'Série čtení: šálek se plní, jak čteš — dočtený brief drží sérii (jde vypnout)',
    ...
    releaseFixed: [
      'Modré pozadí sdílení prosvítalo kolem karet a přes přečtené novinky',
    ],
  ...
  en: {
    ...
    releaseAdded: [
      ...
      'Reading streak: the cup fills as you read — finish the brief to keep it going (optional)',
    ...
    releaseFixed: [
      'The blue share backdrop showed through around cards and read stories',
    ],
