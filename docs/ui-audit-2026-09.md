...
| 9 | Na počítači byl brief pořád jen dlouhý seznam karet vedle sebe ve sloupcích — stejný model čtení jako na telefonu, včetně přepínače Dnes / Top shots. | Na šířce 1100 px a víc se celá novinka vejde na obrazovku bez rolování a vedle ní zbude místo na celý týden; přepínat mezi dneškem a týdnem je tam zbytečné. | Dva sloupce: vlevo dnešek (otevřená novinka jako naše běžná karta, max. 860 px kvůli délce řádku, pod ní „Přečteno, další“ a pruh se zbytkem dne), vpravo užší sloupec s Top shots, tipy, sérií a hodnocením. Záložky jsou v levém panelu, značka a postup dne v horní liště. Mění se jen rozložení, komponenty zůstaly. Telefon i okna pod 1100 px zůstaly u seznamu s přepínačem. |
